  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', width: '100%' }}>
      <div className="sidebar no-print" style={{
        ...
        <div style={{ fontSize: '1.8rem', fontWeight: 'bold', marginBottom: '50px', display: 'flex', alignItems: 'center', gap: '10px' }}>🥗 Marmita Control</div>
      ...
      <div className="main-content" style={{ flexGrow: 1, backgroundColor: 'var(--bg-body)', padding: '40px', transition: 'padding-left 0.3s', maxWidth: '100%' }}>
        ...
        {window.innerWidth >= 1024 && <h1 className="no-print" style={{ fontSize: '2rem', marginBottom: '40px', color: 'var(--text-main)' }}>{getTitle()}</h1>}
        {children}
      </div>
    </div>
  );
